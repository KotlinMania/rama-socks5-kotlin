...
This file is the quick-reference operating contract for rama-socks5-kotlin. The longer
...
rama-socks5-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`rama-socks5`](https://crates.io/crates/rama-socks5). Upstream Rust is the behavioral oracle while the
