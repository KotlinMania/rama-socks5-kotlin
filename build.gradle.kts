...
kotlin {
    ...
    val xcf = XCFramework("RamaSocks5")

    macosArm64 {
        binaries.framework { baseName = "RamaSocks5"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "RamaSocks5"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "RamaSocks5"
        flattenPackage = "io.github.kotlinmania.ramasocks5"
    }

    android {
        namespace = "io.github.kotlinmania.ramasocks5"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "rama-socks5-kotlin", version.toString())

    pom {
        name.set("rama-socks5-kotlin")
        description.set("Kotlin Multiplatform port of plabayo/rama - SOCKS5 support for rama")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/rama-socks5-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/rama-socks5-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/rama-socks5-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/rama-socks5-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleRamaSocks5XCFramework",
    "assembleRamaSocks5DebugXCFramework",
    "assembleRamaSocks5ReleaseXCFramework",
    "assembleDebugIosFatFrameworkForRamaSocks5XCFramework",
    "assembleReleaseIosFatFrameworkForRamaSocks5XCFramework",
    "assembleDebugIosSimulatorFatFrameworkForRamaSocks5XCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForRamaSocks5XCFramework",
    "assembleDebugMacosFatFrameworkForRamaSocks5XCFramework",
    "assembleReleaseMacosFatFrameworkForRamaSocks5XCFramework",
    "assembleDebugTvosFatFrameworkForRamaSocks5XCFramework",
    "assembleReleaseTvosFatFrameworkForRamaSocks5XCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForRamaSocks5XCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForRamaSocks5XCFramework",
    "assembleDebugWatchosFatFrameworkForRamaSocks5XCFramework",
    "assembleReleaseWatchosFatFrameworkForRamaSocks5XCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForRamaSocks5XCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForRamaSocks5XCFramework",
