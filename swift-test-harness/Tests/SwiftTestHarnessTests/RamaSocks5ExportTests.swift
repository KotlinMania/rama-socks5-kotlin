...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `RamaSocks5.swiftmodule/`
...
//      `import RamaSocks5` above would fail at compile time.
//
//   2. The static archive `libRamaSocks5.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "RamaSocks5" }` and
//      `flattenPackage = "io.github.kotlinmania.ramasocks5"` configuration in
...
//      via the `RamaSocks5Library` product.
//
...
final class RamaSocks5ExportTests: XCTestCase {
    func testSwiftModuleLoads() throws {
        XCTAssertTrue(true, "RamaSocks5 swift module imported cleanly")
    }
}
